...
public class ZHStringUtil {
	...
	//方法0-1：返回参数1个中文汉字字符串，字符集必须在GB2312(相当于中文简体)范围内(5分)
	...
	public static String getZHName(){
		...
		//获得姓氏
		String string = str[RandNumUtil.random2(0,str.length-1)];
		//获得名字
		String zhString = getZHString(RandNumUtil.random(1, 3));
		return string+zhString;
	}
}
